...
<html>
	...
	<body>
		<a href="#edit-instituicao" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-instituicao" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${instituicaoInstance?.version}" />
				<fieldset class="form">
